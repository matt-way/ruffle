        ...
        cordova.getThreadPool().execute(new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    //Log.d(LOG_TAG, "Service returned response code " + responseCode);
                ...
                Log.d(LOG_TAG, "response headers: " + connection.getHeaderFields());
                TrackingInputStream inStream = null;
                try {
                    inStream = getInputStream(connection);
                                            
                    ByteArrayOutputStream out = new ByteArrayOutputStream(Math.max(1024, connection.getContentLength()));
