...
angular.module('ruffle.pixelator', [])
	.directive('rfPixelator', function($timeout, $http, $q, $ionicPlatform){
		return {
			...
			template: '<canvas class="ruffle-canvas"></canvas><div class="ruffle-loader" ng-show="loading">Loading</div><div class="ruffle-swipe" ng-if="!touching && !loading && shouldHelp"><div class="ruffle-swipe-cell"><img class="ruffle-swipe-arrow" src="img/swipe.png"/></div></div>',
